...
export default function Collection() {
  ...
  const submitAva = ()=>{
    ...
    const fileRef = ref(storage,`/image/${uid+file.name}`);
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="flex justify-end mt-6">
                <button 
                    ...
                    className="text-black border border-gray-500 px-4 py-2 text-sm font-medium rounded-md bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400"
                >
                    Close
                </button>
            </div>
